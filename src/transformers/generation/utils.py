...
from .beam_search import BeamScorer, BeamSearchScorer, ConstrainedBeamSearchScorer, SSJBeamSearchScorer
...
class GenerationMixin:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            if ssj:
                # 10. prepare beam search scorer
                ssj_beam_scorer = SSJBeamSearchScorer(
                ...
                return self.ssj_beam_search(
                    input_ids,
                    ssj_beam_scorer=ssj_beam_scorer,
                    logits_processor=logits_processor,
                    stopping_criteria=stopping_criteria,
                    pad_token_id=pad_token_id,
                    eos_token_id=eos_token_id,
    ...
    def ssj_beam_search(
        ...
        **model_kwargs,
        ...
        batch_size = len(ssj_beam_scorer._beam_hyps)
        num_beams = ssj_beam_scorer.num_beams
        ...
        while True:
            ...
            # stateless
            beam_outputs = ssj_beam_scorer.process(
                input_ids,
                next_token_scores,
                next_tokens,
                next_indices,
            ...
            if ssj_beam_scorer.is_done or stopping_criteria(input_ids, scores):
                if not synced_gpus:
                    break
                else:
                    this_peer_finished = True

        sequence_outputs = ssj_beam_scorer.finalize(
            input_ids,
            beam_scores,
            next_tokens,
            next_indices,
